...
/*   Updated: 2024/11/29 09:48:12 by cejin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Dog::Dog(const Dog &src) : Aanimal(src.type), brain(new Brain(*src.brain))
{
    std::cout << GREEN
...
Dog::Dog(std::string const &type) : Aanimal(type), brain(new Brain)
{
    std::cout << GREEN
