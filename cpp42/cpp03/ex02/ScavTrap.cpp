...
/*   Updated: 2024/11/26 10:24:41 by cejin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

ScavTrap::ScavTrap() : ClapTrap("Unknown ScavTrap", 100, 50, 10)
{
	std::cout << GREEN
...
ScavTrap::ScavTrap(std::string const &name) : ClapTrap(name, 100, 50, 10)
{
	std::cout << GREEN
